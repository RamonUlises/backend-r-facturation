...
const latestVersion = {
  ...
  pub_date: '2025-06-09T12:00:00Z',
  platforms: {
    windows: {
      url: 'https://api.aricab.shop/aplicacion/actualizar/aricab_2.3.0_x64-setup.exe',
    },
    linux: {
      url: 'https://api.aricab.shop/aplicacion/actualizar/aricab_2.3.0_amd64.deb',
    }
  }
};
